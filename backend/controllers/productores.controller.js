...
// GET /api/preenfrio/productores/productor/:id_productor
const getProductorById = async (req, res) => {
    ...
    try {
        ...
        const productor =
            await productoresModel.getProductorById(id);
...
const createProductor = async (req, res) => {
    ...
    try {
        ...
        const nuevoProductor =
            await productoresModel.createProductor(req.body);
...
// PUT /api/preenfrio/productores/actualizarproductor/:id_productor
const updateProductor = async (req, res) => {
    ...
    try {
        ...
        const productorActualizado =
            await productoresModel.updateProductor(
                id,
                req.body
            );
...
// DELETE /api/preenfrio/productores/eliminarproductor/:id_productor
const deleteProductor = async (req, res) => {
    ...
    try {
        ...
        const productorEliminado =
            await productoresModel.deleteProductor(id);
